        ...
        <div className="relative h-full flex items-center">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                {mounted
                  ? t("about_fellowship_description")
                  : "A transformative initiative dedicated to harnessing the adventurous spirit, resilience, and innovative leadership of African youth."}
              </motion.p>
            </motion.div>
          </div>
        </div>
            ...
            {teamLayers.map((layer) => (
              <div key={layer.title} className="mb-20">
                <h3 className="text-2xl font-semibold text-center mb-10">
                  {mounted
                    ? layer.title === "Project Team"
                      ? t("project_team")
                      : layer.title === "Project Strategy Support Team"
                      ? t("project_strategy_support_team")
                      : t("project_advisors")
                    : layer.title}
                </h3>
